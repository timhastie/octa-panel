...
| cave (modules/synth/synth.s), which is position independent with ratified
| bytes and therefore reads it as an OS absolute. It lives in the OS image
| like qz_scale (the main OS runs from DRAM) and is 0 in the image.
        .text
        .global qz_glide
qz_glide:
        .byte   0
